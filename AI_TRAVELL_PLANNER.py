...
image_url = "https://github.com/Abhiram4u/AI-Travel-planner/blob/main/travel%200.png?raw=true"
...
if st.button("Find Best Travel Options"):
    if source and destination:
        with st.spinner("Fetching best travel options..."):
            ...
            chat_model = ChatGoogleGenerativeAI(api_key="AIzaSyCHGvCV_UsrQLx8EZrb58IQ9qqQEyRNcYI", model="gemini-2.0-flash-exp")
